...
export default function RootLayout() {
  ...
  return (
      <PaperProvider>
          <Tabs screenOptions={{tabBarActiveTintColor: "#888", headerShown: false, tabBarStyle: {paddingTop: 10, backgroundColor: Appearance.getColorScheme() === "dark" ? TabBarDark : TabBarLight}}} backBehavior="order" >
